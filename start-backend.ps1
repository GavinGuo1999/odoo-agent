...
$managedVariablePattern = '^(AGENT_STATE_|AGENT_UI_|ANSWER_LLM_|DEEPSEEK_|GENERAL_LLM_|LANGFUSE_|LLM_PROVIDER$|ODOO_|SEMANTIC_PROVIDER$|SILICONFLOW_|SQL_LLM_|WIKI_|WREN_)'
